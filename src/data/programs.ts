  ...
  // 5. PROGRESJONSSERIER (Oppgave 4)
  {
    ...
    workout: {
      ...
      items: [
        ...
        { id: 'pc2', exercise: { id: 'sideplanke-hoyre', name: 'Sideplanke (høyre side)', category: 'bodyweight' }, workDurationSeconds: 20, restDurationSeconds: 10 },
        { id: 'pc3', exercise: { id: 'sideplanke-venstre', name: 'Sideplanke (venstre side)', category: 'bodyweight' }, workDurationSeconds: 20, restDurationSeconds: 0 },
      ],
    },
  },
  {
